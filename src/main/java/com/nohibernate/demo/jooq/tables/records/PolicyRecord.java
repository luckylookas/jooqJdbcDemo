...
public class PolicyRecord extends UpdatableRecordImpl<PolicyRecord> implements Record2<Long, String> {

    private static final long serialVersionUID = -46628502;
    ...
    /**
     * Setter for <code>public.policy.policy_number</code>.
     */
    ...
    /**
     * Getter for <code>public.policy.policy_number</code>.
     */
     ...
     */
    @Override
    public PolicyRecord values(Long value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public PolicyRecord(Long id, String policyNumber) {
        super(Policy.POLICY);
